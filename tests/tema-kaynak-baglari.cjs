...
assert(entries.length > 0, 'Asset evidence list must not be empty');
...
console.log(entries.length + ' asset references: local files exist and template helper bindings present. No Qukasoft rendering tested.');
